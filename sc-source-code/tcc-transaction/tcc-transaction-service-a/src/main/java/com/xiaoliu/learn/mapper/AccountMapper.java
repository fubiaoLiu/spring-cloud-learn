...
public interface AccountMapper {
     ...
     * @param amount 金额
     */
    @Update("update tb_account_one set amount = amount + #{amount} where acct_id = #{acctId}")
     ...
     * @param amount 金额
     */
    @Update("update tb_account_one set amount = amount - #{amount},frozen = frozen + #{amount} where acct_id = #{acctId}")
     ...
     * @param amount 金额
     */
    @Update("update tb_account_one set frozen = frozen - #{amount} where acct_id = #{acctId}")
