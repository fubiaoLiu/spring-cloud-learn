...
public class TCCServiceCApplication {
    public static void main(String[] args) {
        SpringApplication.run(TCCServiceCApplication.class, args);
        System.out.println("tcc-transaction-service-c started!");
    }
}
